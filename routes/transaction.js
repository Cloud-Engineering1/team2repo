...
router.post("/transfer", async (req, res) => {
  ...
  try {
    ...
    await axios.post(`http://${process.env.NOTIFICATION_SERVICE_HOST}/notifications`,
        { accountId: originAccount.account_pk, message: `Transfer of ${transaction_amount} sent to account ${destinationAccount.account_pk}` },
        { headers: res.locals.headers }
    );
    await axios.post(`http://${process.env.NOTIFICATION_SERVICE_HOST}/notifications`,
        { accountId: originAccount.account_pk, message: `Transfer of ${transaction_amount} received from account ${destinationAccount.account_pk}` },
        { headers: res.locals.headers }
    );
